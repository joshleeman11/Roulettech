...
## Add a recipe
In the top right of the page, enter a name, description, and ingredients. After clicking *Add Recipe*, the newly created recipe will be seen in the main *Community Recipes* list to the left.
